...
@csrf
  <div class="form-group">
    <label >ID Number</label>
    <input value="{{ $student->reg }}" name="reg" type="text" class="form-control"  placeholder="Enter ID Number" readonly="">
  </div>
  ...
  <div class="form-group">
    <label >Last Name</label>
    <input value="{{ $student->lastName }}" name="lastName"  type="text" class="form-control"  placeholder="Enter Last Name" readonly="">
  </div>
...
@csrf
  <div class="form-group">
    <label >ID Number</label>
    <input value="{{ $student->reg }}" name="reg" type="text" class="form-control"  placeholder="Enter ID Number" >
  </div>
